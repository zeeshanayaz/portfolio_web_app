          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="space-y-8">
              <div className="bg-white dark:bg-slate-800/50 backdrop-blur-sm rounded-2xl p-8 shadow-xl border border-slate-200/50 dark:border-slate-700/50">
                ...
                <p className="text-slate-600 dark:text-slate-300 leading-relaxed">{personalInfo.summary}</p>
              </div>
                            ...
                            <Button
                              ...
                              className={`w-8 h-8 p-0 ${
                                storeLink.store === "Google Play"
                                  ...
                                  : "bg-blue-500/10 border-blue-500/20 text-blue-600 dark:text-blue-400 hover:bg-blue-500 hover:text-white"
                              }`}
